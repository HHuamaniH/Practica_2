...
ManCNotificacion.fnLoadManGrillaPaging = function () {
    ...
    columns_label = ['Nro. Resolución', 'Nro. Expediente', 'Título Habilitante', 'Titular', 'Modalidad', 'Medida'
        , 'Impl. Días', 'Impl. Meses', 'Impl. Años', 'Post Impl. Días', 'Post Impl. Meses', 'Post Impl. Anio'
        , 'Inf. Días', 'Inf. Meses', 'Inf. Anios'];
    columns_data = ['NUM_RESOLUCION', 'NUM_EXPEDIENTE', 'NUM_THABILITANTE', 'TITULAR', 'MODALIDAD', 'MEDIDA'
        , 'PLAZO_IMPL_DIA', 'PLAZO_IMPL_MES', 'PLAZO_IMPL_ANIO', 'PLAZO_POST_DIA', 'PLAZO_POST_MES', 'PLAZO_POST_ANIO'
        , 'PLAZO_INF_DIA', 'PLAZO_INF_MES', 'PLAZO_INF_ANIO'];
    ...
    utilSigo.fnAjax(option, function (data) {
        ...
        _ManGrillaPaging.fnExport = function () {
            ...
            let url = `${urlLocalSigo}/Supervision/Reportes/DownloadCorrectiva?asCriterio=${busCriterio}&asValor=${busValor}`;
            ManCNotificacion.getBinary("RPT_MCorretivas", url);
        };
    });
};
