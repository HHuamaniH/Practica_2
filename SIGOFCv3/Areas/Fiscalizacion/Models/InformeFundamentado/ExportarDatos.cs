...
namespace SIGOFCv3.Areas.Fiscalizacion.Models.InformeFundamentado
{
    public class ExportarDatos
    {
        public static ListResult RegistroUsuario(string asCodUsuario)
        {
            ...
            try
            {
                ...
                List<Dictionary<string, string>> olResult = exeCap.ReportesInformeFundamentado(paramCap);
                ...
                if (olResult.Count > 0)
                {
                    ...
                    string rutaExcelBase = rutaBase + "IFUNDAMENTADO_Reg_Usu.xlsx";
