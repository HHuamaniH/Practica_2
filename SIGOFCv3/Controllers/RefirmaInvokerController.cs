...
namespace SIGOFCv3.Controllers
{
    ...
    public class RefirmaInvokerController : Controller
    {
        ...
        public string postArguments(InvokerEntity obj)
        {
            ...
            data["fileUploadUrl"] = string.Format("{0}RefirmaInvoker/upload?folder={1}", this.UrlBase, obj.folder ?? this.PathInvoker);
