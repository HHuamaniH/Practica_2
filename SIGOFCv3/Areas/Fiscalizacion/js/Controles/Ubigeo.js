...
controlesUbigeo.iniciarEventos = function () {
    ...
    controlesUbigeo.frmUbigeo.find("#cboDistrito").change(function () {
        ...
        {           
            ...
            if (formOrigen == "frmInformeFundamentado") {
                ManInfFundamentado_AddEdit.frm.find("#" + controlOrigen).val(ubigeoText);
                ManInfFundamentado_AddEdit.frm.find("#hd" + controlOrigen).val(distSelectId);
                controlesUbigeo.closeUbigeoModal();
