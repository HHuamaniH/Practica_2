...
{
    public class ReportePlanTrabajo
    {
        //public static ListResult GenerarReportePlanTrabajo(int num_paspeq, string periodo)
        //{
        ...
        //public static ListResult GenerarReportePlanManejoEspecies(int num_paspeq, string periodo)
        //{
        //    ListResult result = new ListResult();
        //    try
        //    {
