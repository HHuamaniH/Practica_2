...
using SIGOFCv3.Areas.Fiscalizacion.Models.FiscalizacionNotificacion;
using SIGOFCv3.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Web.Mvc;
using CEntVM = CapaEntidad.ViewModel.VM_FiscalizaNotificacion;
...
{
    public class FiscalizacionNotificacionController : Controller
    {
        ...
        public ActionResult Index(string _alertaIncial = "")
        {
            ...
            ViewBag.ddlListOpciones = logB.RegMostComboIndividual_v3("FIS_NOTIFICACION", "");
        ...
        public ActionResult AddEdit(string asCodNotificacion = "", string asCodTipoN = "", string asTextTipoN="")
        {
            try
            {
                CEntidadN entN = new CEntidadN();
                CLogica logN = new CLogica();

                vmN.lblTituloCabecera = "Notificaciones";
                ...
                vmN.Ent_Notificado = new VM_Persona();
                ...
                else
                {
                    ...
                    entN = logN.RegMostrarListaInfNotiItem(new CEntidadN() { COD_FISNOTI = asCodNotificacion });
                    ...
                    vmN.txtUbigeoDJ = entN.UBIGEOCAMBIO;
                    ...
                    vmN.Ent_Notificado = entN.ENT_NOTIFICADO;
                    vmN.Ent_Notificado.codigoPersona = entN.ListInformes.Count > 0 ? entN.ListInformes[0].COD_TITULAR : "";
                    vmN.Ent_Notificado.tbTelefono =new List<CEntidadP>();
                    vmN.Ent_Notificado.tbCorreo = new List<CEntidadP>();
                    ...
                    {
                        vmN.lblTituloDatosG = "Notificación al Titular";
                ...
                vmN.vmControlCalidad.VALIAS_ROL = mr.VALIAS;
        ...
        public void RegistroLimpiar()
        {
            ...
            vmN.tbInforme = new List<CEntidadN>();
            vmN.tbEliTABLA = new List<CEntidadN>();
        ...
        public JsonResult Grabar(CEntVM obj)
        {
            try
            {
                ...
                if (obj.tbInforme != null || obj.hdfIdOrigenRegistro == "1")
                {
                    ...
                    if ((Boolean)entN.NOTIF_TITULAR)
                    {
                        ...
                        entN.NINTERNET_TITULAR = obj.Ent_Notificado.rb_internet;
                        entN.PARENTESCO = obj.txtParentesco;
                        entN.ENT_NOTIFICADO = new VM_Persona();
                        entN.ENT_NOTIFICADO = obj.Ent_Notificado;
                    ...
                    if (entN.ESTADO_ARCHIVO == "1" || entN.ESTADO_ARCHIVO == "2")
                    {
                        ...
                        string nombreArchivoRegTemp = entN.cCodificacion_SiTD.Trim() + "-Cargo_" + DateTime.Now.Ticks.ToString() + "." + entN.EXTENSION_ARCHIVO;
                        ...
                        {
                            //Se comenta porque la lógica ya no aplica, se genera un nombre único del archvio
                            ...
                            System.IO.File.Copy(Path.Combine(Server.MapPath("~/Archivos/Temporales/"), entN.NOMBRE_TEMPORAL_ARCHIVO), Path.Combine(Server.MapPath("~/Ruta_SITD_Anexos/"), nombreArchivoRegTemp), true);
                        ...
                        entN.NOMBRE_TEMPORAL_ARCHIVO = nombreArchivoRegTemp; //sera el campo CNombreNuevo de la tabla Tra_M_Tramite_Digitales de la bd std_osinfor
                    }
                    else
                    {
                    ...
                    entN.COD_TITULAR = (obj.tbInforme != null &&  obj.tbInforme.Count > 0) ? obj.tbInforme[0].COD_TITULAR : "";
            ...
            catch (Exception)
            {
                ...
                return Json("Hubo un problema en el registro, por favor de verifique sus datos o intente en unos minutos.");
            }
        }
        ...
        {
            vmN.lblTituloItemDoc = "Número Carta remitida al Titular";
        ...
        public JsonResult ConsultaModal(DataTableRequest request = null)
        {
            ...
            CEntidadN paramsBus = new CEntidadN();
            CEntidadN result;
        ...
        public JsonResult GrabarDocumentoAdjunto()
        {
            ...
            if (Request.Files.Count > 0)
            {
                try
                {
                    CEntidadN entN = JsonConvert.DeserializeObject<CEntidadN>(Request.Form["data"]);
