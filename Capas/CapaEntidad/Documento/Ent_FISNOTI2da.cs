...
namespace CapaEntidad.DOC
{
    public class Ent_FISNOTI2da
    {
        ...
        [Description("NUMERO_EXP")]
        public String NUMERO_EXP { get; set; }
        ...
        public List<Ent_FISNOTI2da> ListInformes { get; set; }
        [Category("LIST"), Description("ListParentesco")]
        public List<Ent_FISNOTI2da> ListParentesco { get; set; }
        [Category("LIST"), Description("ListEntidades")]
        public List<Ent_FISNOTI2da> ListEntidades { get; set; }
        [Category("LIST"), Description("ListEliTABLA")]
        public List<Ent_FISNOTI2da> ListEliTABLA { get; set; }
        [Category("LIST"), Description("ListMComboOD")]
        public List<Ent_FISNOTI2da> ListMComboOD { get; set; }
        [Category("LIST"), Description("ListIndicador")]
        public List<Ent_FISNOTI2da> ListIndicador { get; set; }
        [Category("LIST"), Description("ListTipoCNotificacion")]
        public List<Ent_FISNOTI2da> ListTipoCNotificacion { get; set; }
        [Category("LIST"), Description("ListBusqueda")]
        public List<Ent_FISNOTI2da> ListBusqueda { get; set; }
