        ...
        public ActionResult Index()
        {
            try
            {
                ...
                using (WebClient obj = new WebClient())
                {
                    ...
                    var data = obj.DownloadString(new Uri(url + "Tipo/?vaNumGrupoTipo=1&vaNumObligacion=0&pageSize=11"));
                    ...
                    {
                        lstCboTipoObligacion.Add(new VM_Cbo() { Value = item.vaNumTipo, Text = item.vaTipoDescripcion });
                    }
            ...
            try
            {
                ...
                switch (vm.hdfTipoObligacionId)
                {
                    case "1": /** Informe de ejecución **/
                        ...
                        vm.txtfechaARFFS = formatoFecha(objO.faarffsFecha);
                        vm.txtnumOSINFOR = objO.vaosinforNroRegistro;
                        vm.txtfechaOSINFOR = formatoFecha(objO.faosinforFecha);
            ...
            try
            {
                using (WebClient obj = new WebClient())
                {
                    ...
                    var param = "{\"NU_OBLIGACION_BUSQUEDA\": \"" + objO.nU_OBLIGACION_BUSQUEDA + "\"," +
                                ...
                                "\"NV_NOMBREUSUARIO\": \"" + (ModelSession.GetSession())[0].PERSONA + "\"}";
