...
var insertarInforme = function () {
    ...
    let IDENUNCIA_ITECNICO = {
        id_falso: tramiteDenuncia.tablaCartaOficioData.length + 1,
    ...
    tramiteDenuncia.tablaCartaOficioData.push(IDENUNCIA_ITECNICO);
    $("#inputInforme").val('');
...
var obtenrId = function () {
    let count = 1;
    tramiteDenuncia.tablaCartaOficioData.forEach(
        (value) => {
...
var cargarTablaInforme = function () {
    tramiteDenuncia.tablaInforme = $('#grvInforme').DataTable({
        ...
        data: tramiteDenuncia.tablaCartaOficioData,
...
var EliminarInforme = function (ID) {
    tramiteDenuncia.tablaCartaOficioData =
        tramiteDenuncia.tablaCartaOficioData.filter(
            tramite => {
