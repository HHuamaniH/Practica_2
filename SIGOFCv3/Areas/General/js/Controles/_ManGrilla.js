...
_manGrilla.fnSearchDataTable = function () {
    var valorBusqueda = _manGrilla.frmManGrilla.find("#txtValor").val();

    if (valorBusqueda.trim() == "") {
        utilSigo.toastWarning("Aviso", "Ingrese Valor a Buscar");
        _manGrilla.frmManGrilla.find("#txtValor").focus();
        return false;
    }
    else {
        ...
        if (_manGrilla.isPaging) {
            ...
            var valbusFormulario=_manGrilla.frmManGrilla.find("#tipoFormulario").val();
            var busCriterio = _manGrilla.frmManGrilla.find("#cboOpciones").val();
            _manGrilla.fnSearch({   busFormulario: valbusFormulario,
                                    busCriterio: busCriterio,
                                    busValor: valorBusqueda.trim()});
        }
    }
}

_manGrilla.fnRefreshDataTable = function () {
    _manGrilla.frmManGrilla.find("#txtValor").val("");
